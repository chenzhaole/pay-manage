...
public class GwRegisteMchtController {

    protected final Logger logger = LoggerFactory.getLogger(GwRegisteMchtController.class);

    @Autowired
    ITradeRegisteMchtHandler tradeRegisteMchtHandler;
    ...
    public MchtRegisteResponse callHandler(TradeBaseRequest tradeRequest, String ip, String midoid) {
        ...
        try {
            ...
            CommonResult commonResult = (CommonResult) tradeRegisteMchtHandler.process(tradeRequest, ip);
