...
//import com.sys.boss.api.service.trade.handler.ITradeRegisteMchtHandler;
...
//public class GwRegisteMchtController_v1 {
//
//    protected final Logger logger = LoggerFactory.getLogger(GwRegisteMchtController_v1.class);
//
//    @Autowired
//    ITradeRegisteMchtHandler tradeRegisteMchtInfoHandler;
//
//    private final String BIZ = PayTypeEnum.REGISTE_MCHT.getDesc() + "-";
//
//
//    @RequestMapping(value = "/gateway/api/registeMcht")
//    @ResponseBody
//    public String registeMcht(@RequestBody String data, HttpServletRequest request, HttpServletResponse response, RedirectAttributes redirectAttributes) throws java.io.IOException {
...
//                logger.info(BIZ + midoid + " body中必填参数值不能为空,即MchtRegisteRequestBody：" + JSONObject.toJSONString(body));
//                return checkResp;
//            }
//
...
//            CommonResult commonResult = (CommonResult) tradeRegisteMchtInfoHandler.process(tradeRequest, ip);
