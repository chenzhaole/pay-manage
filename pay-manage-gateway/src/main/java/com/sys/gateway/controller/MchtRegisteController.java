...
import com.sys.boss.api.service.trade.handler.ITradeMchtRegisteHandler;
...
public class MchtRegisteController {

    protected final Logger logger = LoggerFactory.getLogger(MchtRegisteController.class);
    ...
    public MchtRegisteResponse callHandler(TradeBaseRequest tradeRequest, String ip, String midoid) {
        ...
        try {
            ...
            CommonResult commonResult = (CommonResult) tradeMchtRegisteHandler.process(tradeRequest, ip);
