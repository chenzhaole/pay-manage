...
<head>
    ...
    <script type="text/javascript" src="${ctxStatic}/qrweb/js/userAgent.js"></script>
    <script type="text/javascript" src="${ctxStatic}/qrweb/js/pager.js"></script>
    <script type="text/javascript" src="${ctxStatic}/qrweb/js/common.js"></script>
    <!-- td埋点 -->
    <script type="text/javascript" src="${ctxStatic}/qrweb/js/CN2/td-h5-website-sdk.js" td-appid="AD559"></script>
    ...
    $(function () {
        $("#pager_next").click(function () {
            ...
            if (status == 1) {
                ...
                $.ajax({
                    type: "post",
                    url: "/gwqr/order/list" + "?mchtId=" + "3310000000666666",
                    data: "pageNo=" + pageNo,
                    dataType: "json",
...
//            document.getElementById("chooseArea").value="111";
        ...
        var url = "/gwqr/order/detail?platOrderId="+platOrderId+"&yyyyMM="+yyyyMM;
