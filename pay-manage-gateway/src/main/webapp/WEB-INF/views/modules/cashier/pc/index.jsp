...
<div class="content">
    <div class="container">
        <div class="order">
            ...
            <span class="orderNum">订单编号：${tradeCashierResponse.orderId}</span>
        </div>
        <div class="goodsInfo">
            <span class="goodsName">商品名称：<b>${tradeCashierResponse.goods}</b></span>
            <span class="price">应付金额：<b>￥</b><b class="totalprice">${tradeCashierResponse.amount}</b></span>
    ...
    <div class="container">
        ...
        <div class="layui-tab layui-tab-brief" lay-filter="pay">
            ...
            <div class="layui-tab-content">
                ...
                <!--提示-->
                <div class="layui-tab-item nopay " id="wxTips">
                ...
                <div class="layui-tab-item nopay " id="aliTips">
                    <div class="warn-content">
                        <img src="${ctxStatic}/images/pop3.png" alt="暂未支付" />
                        <p>该订单暂未支付，请继续支付</p>
                        <button class="layui-btn">重新支付</button>
