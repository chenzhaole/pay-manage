                ...
                <dl class="content">
                    ...
                    <dd>
                        ...
                        <select name="payUrl" onchange="doChange()">
                            ...
                            <option value="http://13.250.235.186:12080/gateway/cashier/mchtCall">AWS http://13.250.235.186:12080/gateway/cashier/mchtCall</option>
                        </select>
                    ...
                    <dd>
                        ...
                        <select name="biz"  >
                            ...
                            <option value="qj000">银行卡组合支付类型</option>
