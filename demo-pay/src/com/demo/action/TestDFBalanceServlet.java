...
public class TestDFBalanceServlet extends HttpServlet {
    ...
    private static final String PUBLIC_KEY =  "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQCm++Z9qgw6HxIOKWbAx1hbVU7PokmBBFlomwFhBdU2LInAQWfHEJTGM+2EX9D559J3XXxcPSVanVdM4LcTiJyVJoFSulIg01wR26yk7pzGqy+QJRv1uffL1+otRbgmDLhjeV16148CmwGG3j7xkVOqrv/fsiOViYd1EZdsit+vlQIDAQAB";
    ...
    public static void main(String[] args) throws Exception {
        String payUrl = "http://106.2.6.41:17082/df/gateway/balance/";
        String key = "1bd91dc5af4e400aabd253d938296bcd";

        JSONObject data = new JSONObject();
        JSONObject head = new JSONObject();
        head.put("mchtId", "2000820000565296");
        head.put("version", "20");
        head.put("biz", "df102");

        //获取body
        Map<String, String> bodyMap = new HashMap<>();
        bodyMap.put("mchtId", "2000820000565296");
