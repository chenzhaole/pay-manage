	...
	<script type="text/javascript">
    	...
    	function updateSort() {
			...
			$(".digits").each(function(){
				...
				if ($(this).val() != "" && !isUnsignedInteger($(this).val())) {
					top.$.jBox.tip('请输入正确的数字!','warning');
					valid = false;
					$(this).focus();
					return false;
				}
				...
				<tr id="${menu.id}" pId="${menu.parent.id ne 1?menu.parent.id:'0'}">
					...
					<td style="text-align:center;">
						<shiro:hasPermission name="sys:menu:edit">
							...
							<input name="sorts" type="text" class="digits" maxlength="5" value="${menu.sort}" style="width:50px;margin:0;padding:0;text-align:center;">
