...
<body>
	...
	<form:form id="inputForm" modelAttribute="area" action="${ctx}/sys/area/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			<label class="control-label">区域英语名称:</label>
			<div class="controls">
				<form:input path="nameEnglish" htmlEscape="false" maxlength="50" class="required"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">区域短名称:</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label">区域短码:</label>
			<div class="controls">
				<form:input path="areaCode" htmlEscape="false" maxlength="50"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">区域善园内部码:</label>
			<div class="controls">
				<form:input path="ownCode" htmlEscape="false" maxlength="50"/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			<label class="control-label">区域邮编:</label>
			<div class="controls">
				<form:input path="postcode" htmlEscape="false" maxlength="50"/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="form-actions">
			...
			<input id="btnCancel" class="btn" type="button" value="返 回" onclick="window.location.href='${ctx}/sys/area/'"/>
		</div>
	</form:form>
</body>
</html>