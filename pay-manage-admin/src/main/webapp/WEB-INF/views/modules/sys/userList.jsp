...
<body>
	...
	<form:form id="searchForm" modelAttribute="user" action="${ctx}/sys/user/" method="post" class="breadcrumb form-search">
		...
		<div>
			<c:if test="${fns:isCurrentPlatform()}">
				<label>归属机构：</label><tags:treeselect id="company" name="company.id" value="${user.company.id}" labelName="company.name" labelValue="${user.company.name}"
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead><tr>
            <th>归属机构</th>
            <th class="sort loginName"><a href="javascript:">登录名</a></th>
            <th class="sort name"><a href="javascript:">姓名</a></th>
		...
		<c:forEach items="${page.list}" var="user">
			<tr>
				...
				<td>${user.phone}</td>
				<td>${user.mobile}</td>
				<td style="word-wrap:break-word; word-break:break-all;">${user.roleNames}</td>
				<shiro:hasPermission name="sys:user:edit"><td style="white-space:nowrap;">
