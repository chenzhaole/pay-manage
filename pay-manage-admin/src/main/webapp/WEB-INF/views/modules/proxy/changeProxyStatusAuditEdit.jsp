        ...
        $(function () {
            ...
            $("#channelForm").validate({
                ...
                submitHandler: function (form) {   //表单提交句柄,为一回调函数，带一个参数：form
                    showShadow();
                    document.forms[0].action = "${ctx}/proxy/changeProxyStatusAuditSave";
...
<form id="channelForm" action="" method="post">
	...
	<table class="table">
		...
		<tr>1
			...
			<td>
				<div class="control-group">
					<label class="control-label" for="auditNotes">审批说明</label>
					<div class="controls">
                        <textarea name="auditNotes" placeholder="" id="auditNotes"
