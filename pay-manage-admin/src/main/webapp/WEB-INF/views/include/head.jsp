...
<script src="${ctxStatic}/jquery/jquery-migrate-1.2.0.min.js" type="text/javascript"></script>
...
<link href="${ctxStatic}/common/common.min.css" type="text/css" rel="stylesheet" />
<script src="${ctxStatic}/common/common.min.js" type="text/javascript"></script>
