...
function(e) {
	...
	A.prototype.setArea = function() {
		...
		function() {
			var e = function(i) {
				var a, l;
				return i = i || t.elem.parent(),
				a = i.width(),
				l = "none" === i.css("display"),
				 !i[0] || a && !l ? a: e(i.parent())
//      a
			};
			return e()
		} ();
	...
	A.prototype.sort = function(e, i, a, n) {
		...
		try {
			...
			u.layHeader.find("th").find(w).removeAttr("lay-sort"),
			m.attr("lay-sort", i || null),
			u.layFixed.find("th")
		} catch(v) {
		...
		"asc" === i ? c = layui.sort(p, r) : "desc" === i ? c = layui.sort(p, r, !0) : (c = layui.sort(p, d.config.indexName), delete u.sortKey),
		h[f.response.dataName] = c,
		u.renderData(h, u.page, u.count, !0),
		l.close(u.tipsIndex),
		n && layui.event.call(e, s, "sort(" + y + ")", {
			field: r,
			type: i
		})
	},
	...
	A.prototype.fullSize = function() {
		...
		i = t.config,
		a = i.height;
		t.fullHeightGap && (a = M.height() - t.fullHeightGap, a < 135 && (a = 135), t.elem.css("height", a)),
