...
jQuery.validator.addMethod("versionCode", function(value, element) {
...
jQuery.validator.addMethod("simplePhone", function(value, element) {
    var tel = /^(((400)-(\d{4})-(\d{3}))|((400)-(\d{3})-(\d{4}))|((400)-(\d{2})-(\d{5})))$|^((\d{7,8})|(\d{4}|\d{3})-(\d{7,8})|(\d{4}|\d{3})-(\d{3,7,8})-(\d{4}|\d{3}|\d{2}|\d{1})|(\d{7,8})-(\d{4}|\d{3}|\d{2}|\d{1}))$/;
...
jQuery.validator.addMethod("phone", function(value, element) {     
	var tel = /(^0[1-9]{1}\d{9,10}$)|(^1[3,5,8,4,7]\d{9}$)/g;
	return this.optional(element) || (tel.test(value));     
