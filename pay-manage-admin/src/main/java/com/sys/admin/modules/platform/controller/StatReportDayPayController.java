...
public class StatReportDayPayController extends BaseController {
    ...
    public String reStat( String tradeDate , HttpServletRequest request,  Model model) {
        ...
        return "redirect:/platform/statReportDayPayList/list";
    ...
    public String exportProxy(HttpServletResponse response, HttpServletRequest request, RedirectAttributes redirectAttributes,
        ...
        String[] headers = {"日期","支付业务交易金额(元)" ,"支付业务利润(元)","代付业务交易金额(元)" ,"代付业务利润(元)","代付交易笔数","代付交易利润(元)","利润合计(元)","操作"};
