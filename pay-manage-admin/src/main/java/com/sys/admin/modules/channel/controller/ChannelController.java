...
//		model.addAttribute("list", chanInfoList);
		...
		//过滤掉不常用的
		model.addAttribute("paymentTypeInfos", this.filterPayTypeList(prePayTypeList));
...
//		model.addAttribute("paymentTypeInfos", paymentTypeInfos);
	...
	public Map<String, String> notOftenUsePayTypeMaps(){
	 ...
	 * @return
	 */
	private PayTypeEnum[] filterPayTypeList(PayTypeEnum[] prePayTypeList) {
