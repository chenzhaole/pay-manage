 ...
 * RSA加密解密工具
 * <p/>
 * <b>注意：</b> 使用本工具加密的数据长度不能超过117字节，解密数据长度不能超过128字节
 * <p/>
 * =======================================================================
 */
public class RSAEncrypt {
     ...
     * 随机生成密钥对
     */
    public static void genKeyPair(String publicKeyPath, String privateKeyPath) {
        ...
        try {
            ...
            // 将密钥对写入到文件
            pubfw = new FileWriter(publicKeyPath);
            prifw = new FileWriter(privateKeyPath);
