...
/**
 * 图片工具
 * Created by ALI on 2017/9/30.
 */
public class PictureUtils {

    public static final String PIC_DOMAIN = ConfigUtil.getValue("image.server");
    public static final String ASSETS="adminImg";
    ...
    public static String assemblePicUrl(String purePicUrl){
        if(StringUtils.isBlank(purePicUrl)) {
			return null;
		}
