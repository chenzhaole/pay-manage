    ...
    init: function (field) {
        ...
        Ext.apply(field, {
            ...
            , validateRemote: function () {
                ...
                try {
                    this.rvOptions.params.validateValue = this.getValue();
                    Ext.Ajax.request(this.rvOptions);
                }
                catch (e) {
                    //如果是失去焦点验证，当表单窗户关闭是触发需要此验证
                    return false;
                }
            }
            ...
            , rvSuccess: function (response, options) {
                ...
                try {
                    ...
                    if (!o.success && o.msg && exceptionHandle) {
                        exceptionHandle(o.msg);
                    }
                }
                catch (e) {
        ...
        Ext.applyIf(field, {
            remoteValidationDelay: 500, reason: 'Server has not yet validated the value', cannotDecodeText: 'Cannot decode json object', notObjectText: 'Server response is not an object', serverErrorText: 'Server error', requestFailText: 'Server request failed'
        });
        ...
        Ext.applyIf(field.rvOptions, {
            method: 'post', scope: field, success: field.rvSuccess, failure: field.rvFailure, paramNames: {
